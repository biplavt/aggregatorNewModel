...
var aftpUsersTotals = {
  upsertUserTotals: function (aftps, callback) {
    // console.log(aftps);
      // removeAftpUsersTotalBySiteID = function (siteID, removeCallback) {
      //     return db.query("DELETE FROM aftpUsersTotals_TB WHERE siteID=?", siteID,removeCallback)
      // }
...
module.exports = aftpUsersTotals;